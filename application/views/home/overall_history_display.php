<div class="container">
        ...
        <form action="/user/search_processes_time" method="POST" onsubmit="return validateSearchProcess();">
        <div class="row">
            <div class="col-md-12">
                <br/>
            </div>
            ...
            <div class="col-md-4">
              <input type="text" id="starting_time" name="starting_time" class="form-control" value="<?php if(isset($starting_time)) echo $starting_time; ?>">
            </div>
            ...
            <div class="col-md-4">
              ...
              <input type="text" id="ending_time" name="ending_time" class="form-control" value="<?php if(isset($ending_time)) echo $ending_time; ?>">
            </div>
            <div class="col-md-6"></div>
...
<script>
  function validateSearchProcess()
  {
      ...
      {
          alert("Ending time cannot be empty.");
          return false;
      }
  }
