...
<ul role="tree" aria-labelledby="tree_label">
  ...
  <?php
     ...
     {
  ?>
    <li role="treeitem" aria-selected="false" class="doc" title='<?php echo formatBytes($file->file_size); ?>'><img src='/pix/file-64.png' width="22px" />
      <?php
  ...
  <?php
     $folders = $mpjson->Sub_dirs;
     foreach($folders as $folder)
     {
  ?>
    <li role="treeitem" aria-expanded="false" aria-selected="false"><img src='/pix/folder-48.png' width="22px" />
     <?php
        echo $folder;
     ?>
      <ul role="group">
      ...
      case this.keyCode.SPACE:
        ...
        if (!label) {
          ...
          label = child ? child.innerText : treeitem.innerText;
                ...
                //Willy: Update the selected item
