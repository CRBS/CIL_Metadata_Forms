            ...
            <?php 
                ...
                if(isset($json->CIL_CCDB->CIL->CORE->IMAGINGMODE))
                {
                    ...
                    if(is_array($itemsJson))
                    {
                        ...
                        {
                            if(isset($item->free_text))
                                echo "<li>".$item->free_text."<a  href=\"/image_metadata/delete_field_by_index/".$image_id."/IMAGINGMODE/".$i."\" target=\"_self\"> &#x2716;</a></li>";
                            else if(isset($item->onto_name) && isset($item->onto_id))
                            {
                                echo "<li><a href=\"#\" data-toggle=\"tooltip\" title=\"".$item->onto_id."\">".$item->onto_name."</a><a  href=\"/image_metadata/delete_field_by_index/".$image_id."/IMAGINGMODE/".$i."\" target=\"_self\"> &#x2716;</a></li>";
                            }
            ...
            <?php 
                ...
                if(isset($json->CIL_CCDB->CIL->CORE->VISUALIZATIONMETHODS))
                {
                    ...
                    if(is_array($itemsJson))
                    {
                        ...
                        {
                            if(isset($item->free_text))
                                echo "<li>".$item->free_text."<a  href=\"/image_metadata/delete_field_by_index/".$image_id."/VISUALIZATIONMETHODS/".$i."\" target=\"_self\"> &#x2716;</a></li>";
                            else if(isset($item->onto_name) && isset($item->onto_id))
                            {
                                echo "<li><a href=\"#\" data-toggle=\"tooltip\" title=\"".$item->onto_id."\">".$item->onto_name."</a><a  href=\"/image_metadata/delete_field_by_index/".$image_id."/VISUALIZATIONMETHODS/".$i."\" target=\"_self\"> &#x2716;</a></li>";
                            }
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label class="col-form-label" for="inputDefault"> Preparation</label>
            <?php 
                if(isset($json->CIL_CCDB->CIL->CORE->PREPARATION))
                {
                    $itemsJson = $json->CIL_CCDB->CIL->CORE->PREPARATION;
                    if(is_array($itemsJson))
                    {
                        echo "<ul>";
                        foreach($itemsJson as $item)
                        {
                            if(isset($item->free_text))
                                echo "<li>".$item->free_text."<a  href=\"/image_metadata/delete_field/".$image_id."/PREPARATION/".$item->free_text."\" target=\"_self\"> &#x2716;</a></li>";
                            else if(isset($item->onto_name) && isset($item->onto_id))
                            {
                                echo "<li><a href=\"#\" data-toggle=\"tooltip\" title=\"".$item->onto_id."\">".$item->onto_name."</a><a  href=\"/image_metadata/delete_field/".$image_id."/PREPARATION/".$item->onto_name."\" target=\"_self\"> &#x2716;</a></li>";
                            }
                        }
                        echo "</ul>";
                    }
            ...
            ?>
            <input id="image_search_parms_preparation_bim" name="image_search_parms[preparation_bim]" style="width: 100%" type="text" value="" class="acInput form-control cil_san_regular_font ui-autocomplete-input" autocomplete="off">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label class="col-form-label" for="inputDefault"> Parameter Imaged</label>
            <?php 
                if(isset($json->CIL_CCDB->CIL->CORE->PARAMETERIMAGED))
                {
                    $itemsJson = $json->CIL_CCDB->CIL->CORE->PARAMETERIMAGED;
                    if(is_array($itemsJson))
                    {
                        echo "<ul>";
                        foreach($itemsJson as $item)
                        {
                            if(isset($item->free_text))
                                echo "<li>".$item->free_text."<a  href=\"/image_metadata/delete_field/".$image_id."/PARAMETERIMAGED/".$item->free_text."\" target=\"_self\"> &#x2716;</a></li>";
                            else if(isset($item->onto_name) && isset($item->onto_id))
                            {
                                echo "<li><a href=\"#\" data-toggle=\"tooltip\" title=\"".$item->onto_id."\">".$item->onto_name."</a><a  href=\"/image_metadata/delete_field/".$image_id."/PARAMETERIMAGED/".$item->onto_name."\" target=\"_self\"> &#x2716;</a></li>";
                            }
                        }
                        echo "</ul>";
                    }
            ...
            ?>
            <input id="image_search_parms_parameter_imaged_bim" name="image_search_parms[parameter_imaged_bim]" style="width: 100%" type="text" value="" class="acInput form-control cil_san_regular_font ui-autocomplete-input" autocomplete="off">
        </div>
    </div>
</div>